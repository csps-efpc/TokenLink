...
#
# t_dat |>
#   joined_results(pairs_to_get = 'positive_evidence', include_row_numbers = TRUE, link_col_nms = c('posterior', 'tokens_in_favour', 'tokens_against'))
#
#
# TOKEN_MAX_COMPARE_DEFAULT
# tokens_to_keep
# max_total_comparisons = 23726846
# max_total_comparisons = 25000000
# max_total_comparisons = 100000000
#
#
# t_dat$tokens_all |>
#   filter(str_detect(token, 'harb')) |>
#   mutate(n_max = pmax(n.vend, n.ised)) |> View()
#
...
#
#
# t_dat$tokens_all |> filter(n.vend == 1 & n.ised == 1) |> arrange(n_comparisons) |> sample_n(1000) |> view()
